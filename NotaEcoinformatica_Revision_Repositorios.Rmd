...
author: Antonio Canepa-Oneto^1^ , Claudia Fernández Ruiz^1^
...
> Autor de correspondencia\*: Antonio Canepa-Oneto [[ajcanepa@ubu.es](mailto:ajcanepa@ubu.es){.email}]
...
Tendré que ir respondiendo uno a uno (no es tan difícil). Hay algunos comentarios que indican que use funciones en vez de "chunks" de código, pero hay que darle una vuelta porque esto cambia bastante el sentido, porque cómo estarán distribuidas las funciones? porque la idea sería un paquete, pero no tengo tiempo para eso.
